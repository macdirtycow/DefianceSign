...
struct Options: Codable, Equatable {
	...
	/// If MapleSign should remove the app after signed it in the Downloaded Apps options
    var removeApp: Bool
    /// If MapleSign should only modify and no signing
    var onlyModify: Bool
	/// If MapleSign copy things should start in the last used location instead of Documents dir
	var useLastExportLocation: Bool?
	/// If MapleSign should use Zip or ZIPFoundation
    ...
    /// If MapleSign should use background audio
    var backgroundAudio: Bool
    /// If MapleSign should show logs when signing
    var signingLogs: Bool
    /// If MapleSign should notify when download is completed

...
extension ServerInstaller {
	...
	var externalServerLink: String {
		let baseUrl = "\(MapleSignConfig.plistProxyBase)?bundleid=\(app.identifier!)&name=\(app.name!)&version=\(app.version!)&fetchurl=\(self.payloadEndpoint.absoluteString)"
	...
	var installManifest: [String: Any] {[
		"items": [[
			"assets": [
				...
				[
					"kind": "display-image",
					"url": "https://raw.githubusercontent.com/Nyasami/MapleSign/refs/heads/main/MapleSign/Resources/Assets.xcassets/AppIcons/AppIcon.appiconset/MapleSign-default.png",
				],
			],
			"metadata": [

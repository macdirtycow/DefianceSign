...
struct FileRow: View {
    ...
    private func fileConfirmationDialogButtons() -> some View {
        ...
        if file.isMapleSignFile {
            Button {
                UIAlertController.showAlertWithOk(title: "?", message: .localized("MapleSign certificate file (.maplesign) is now unsupported from v1.5.1, please refer to use .p12 and .mobileprovision instead."))
            } label: {

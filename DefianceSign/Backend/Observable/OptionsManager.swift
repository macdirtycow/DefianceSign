...
struct Options: Codable, Equatable {
	...
	/// If DefianceSign should remove the app after signed it in the Downloaded Apps options
    var removeApp: Bool
    /// If DefianceSign should only modify and no signing
    var onlyModify: Bool
	/// If DefianceSign copy things should start in the last used location instead of Documents dir
	var useLastExportLocation: Bool?
	/// If DefianceSign should use Zip or ZIPFoundation
    ...
    /// If DefianceSign should use background audio
    var backgroundAudio: Bool
    /// If DefianceSign should show logs when signing
    var signingLogs: Bool
    /// If DefianceSign should notify when download is completed

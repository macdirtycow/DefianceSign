...
extension ServerInstaller {
	...
	var externalServerLink: String {
		let baseUrl = "\(DefianceSignConfig.plistProxyBase)?bundleid=\(app.identifier!)&name=\(app.name!)&version=\(app.version!)&fetchurl=\(self.payloadEndpoint.absoluteString)"
	...
	var installManifest: [String: Any] {[
		"items": [[
			"assets": [
				...
				[
					"kind": "display-image",
					"url": "https://raw.githubusercontent.com/Nyasami/DefianceSign/refs/heads/main/DefianceSign/Resources/Assets.xcassets/AppIcons/AppIcon.appiconset/DefianceSign-default.png",
				],
			],
			"metadata": [
